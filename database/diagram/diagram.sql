...
CREATE TABLE IF NOT EXISTS `db`.`user` (
  ...
  `fullsizeimages` TINYINT NOT NULL DEFAULT 0,
  `created` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `db`.`subscription_type` (
  ...
  `price` SMALLINT NOT NULL COMMENT 'Price in cents.',
  `idgazette_type` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `db`.`recipient` (
  ...
  INDEX `fk_recipient_user2_idx` (`pending_referent` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `db`.`payment_service`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db`.`payment_service` ;

CREATE TABLE IF NOT EXISTS `db`.`payment_service` (
  `idpayment_service` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `enabled` TINYINT NOT NULL DEFAULT 0,
  PRIMARY KEY (`idpayment_service`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `db`.`payment_type` (
  ...
  `idpayment_service` INT NOT NULL,
  `name` VARCHAR(45) NOT NULL,
  `enabled` TINYINT NOT NULL DEFAULT 0,
  PRIMARY KEY (`idpayment_type`),
  INDEX `fk_payment_type_payment_service1_idx` (`idpayment_service` ASC) VISIBLE,
  CONSTRAINT `fk_payment_type_payment_service1`
    FOREIGN KEY (`idpayment_service`)
    REFERENCES `db`.`payment_service` (`idpayment_service`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db`.`monthly_payment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db`.`monthly_payment` ;

CREATE TABLE IF NOT EXISTS `db`.`monthly_payment` (
  `idmonthly_payment` INT NOT NULL AUTO_INCREMENT,
  `iduser` INT NOT NULL,
  `idsubscription` INT NOT NULL,
  `original_payment` INT NOT NULL,
  PRIMARY KEY (`idmonthly_payment`),
  INDEX `fk_monthly_payment_user1_idx` (`iduser` ASC) VISIBLE,
  INDEX `fk_monthly_payment_subscription1_idx` (`idsubscription` ASC) VISIBLE,
  UNIQUE INDEX `unique_user_subscription` (`iduser` ASC, `idsubscription` ASC) VISIBLE,
  INDEX `fk_monthly_payment_payment1_idx` (`original_payment` ASC) VISIBLE,
  CONSTRAINT `fk_monthly_payment_user1`
    FOREIGN KEY (`iduser`)
    REFERENCES `db`.`user` (`iduser`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_monthly_payment_subscription1`
    FOREIGN KEY (`idsubscription`)
    REFERENCES `db`.`subscription` (`idsubscription`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_monthly_payment_payment1`
    FOREIGN KEY (`original_payment`)
    REFERENCES `db`.`payment` (`idpayment`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `db`.`payment` (
  ...
  INDEX `fk_user_has_payment_payment_type1_idx` (`idpayment_type` ASC) VISIBLE,
  PRIMARY KEY (`idpayment`),
  INDEX `fk_payment_user_has_subscription1_idx` (`idmonthly_payment` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_user_has_payment_subscription1`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_user_has_payment_payment_type1`
    FOREIGN KEY (`idpayment_type`)
    REFERENCES `db`.`payment_type` (`idpayment_type`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_payment_user_has_subscription1`
    FOREIGN KEY (`idmonthly_payment`)
    REFERENCES `db`.`monthly_payment` (`idmonthly_payment`)
    ON DELETE SET NULL
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `db`.`publication_has_picture` (
  ...
  INDEX `fk_publication_has_picture_s31_idx` (`crop` ASC) VISIBLE,
  INDEX `fk_publication_has_picture_s32_idx` (`cover` ASC) VISIBLE,
  INDEX `fk_publication_has_picture_s33_idx` (`mini` ASC) VISIBLE,
  INDEX `fk_publication_has_picture_s34_idx` (`full_size` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_publication_has_picture_s31`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_publication_has_picture_s32`
    FOREIGN KEY (`cover`)
    REFERENCES `db`.`s3` (`idobject`)
    ON DELETE SET NULL
    ON UPDATE CASCADE,
  CONSTRAINT `fk_publication_has_picture_s33`
    FOREIGN KEY (`mini`)
    REFERENCES `db`.`s3` (`idobject`)
    ON DELETE SET NULL
    ON UPDATE CASCADE,
  CONSTRAINT `fk_publication_has_picture_s34`
    FOREIGN KEY (`full_size`)
    REFERENCES `db`.`s3` (`idobject`)
    ON DELETE SET NULL
    ON UPDATE CASCADE)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `db`.`gazette` (
  ...
  INDEX `fk_gazette_s34_idx` (`cover_full` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_gazette_recipient1`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_gazette_s34`
    FOREIGN KEY (`cover_full`)
    REFERENCES `db`.`s3` (`idobject`)
    ON DELETE SET NULL
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db`.`payment_service_uid`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db`.`payment_service_uid` ;

CREATE TABLE IF NOT EXISTS `db`.`payment_service_uid` (
  `idpayment_service` INT NOT NULL,
  `iduser` INT NOT NULL,
  `uid` VARCHAR(45) NOT NULL,
  INDEX `fk_payment_service_account_payment_service1_idx` (`idpayment_service` ASC) VISIBLE,
  INDEX `fk_payment_service_account_user1_idx` (`iduser` ASC) VISIBLE,
  UNIQUE INDEX `unique_user_service` (`idpayment_service` ASC, `iduser` ASC) VISIBLE,
  CONSTRAINT `fk_payment_service_account_payment_service1`
    FOREIGN KEY (`idpayment_service`)
    REFERENCES `db`.`payment_service` (`idpayment_service`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_payment_service_account_user1`
    FOREIGN KEY (`iduser`)
    REFERENCES `db`.`user` (`iduser`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
START TRANSACTION;
USE `db`;
INSERT INTO `db`.`subscription_type` (`idsubscription_type`, `name`, `price`, `idgazette_type`) VALUES (1, 'Mensuel', 599, 1);

COMMIT;


-- -----------------------------------------------------
-- Data for table `db`.`payment_service`
-- -----------------------------------------------------
START TRANSACTION;
USE `db`;
INSERT INTO `db`.`payment_service` (`idpayment_service`, `name`, `enabled`) VALUES (1, 'easytransac', 1);

COMMIT;


-- -----------------------------------------------------
-- Data for table `db`.`payment_type`
-- -----------------------------------------------------
START TRANSACTION;
USE `db`;
INSERT INTO `db`.`payment_type` (`idpayment_type`, `idpayment_service`, `name`, `enabled`) VALUES (1, 1, 'payment', 1);
INSERT INTO `db`.`payment_type` (`idpayment_type`, `idpayment_service`, `name`, `enabled`) VALUES (2, 1, 'debit', 0);
INSERT INTO `db`.`payment_type` (`idpayment_type`, `idpayment_service`, `name`, `enabled`) VALUES (3, 1, 'paybybank', 1);
