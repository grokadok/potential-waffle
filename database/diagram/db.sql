...
-- -----------------------------------------------------
-- Table `db`.`user_unseen_comment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db`.`user_unseen_comment` ;

CREATE TABLE IF NOT EXISTS `db`.`user_unseen_comment` (
  `iduser` INT NOT NULL,
  `idcomment` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `db`.`user_unseen_publication`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db`.`user_unseen_publication` ;

CREATE TABLE IF NOT EXISTS `db`.`user_unseen_publication` (
  `iduser` INT NOT NULL,
  `idpublication` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `db`.`user_unseen_member`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db`.`user_unseen_member` ;

CREATE TABLE IF NOT EXISTS `db`.`user_unseen_member` (
  `iduser` INT NOT NULL,
  `member` INT NOT NULL,
  `idfamily` INT NOT NULL,
