...
CREATE TABLE IF NOT EXISTS `db`.`publication_has_picture` (
  ...
  INDEX `fk_publication_has_picture_s31_idx` (`idpicture` ASC) VISIBLE,
...
START TRANSACTION;
USE `db`;
INSERT INTO `db`.`publication_type` (`idpublication_type`, `name`) VALUES (1, 'text');
...
START TRANSACTION;
USE `db`;
INSERT INTO `db`.`layout` (`idlayout`, `description`, `quantity`, `orientation`) VALUES (2, 'h1:1', 2, 0);
INSERT INTO `db`.`layout` (`idlayout`, `description`, `quantity`, `orientation`) VALUES (3, 'h2:1', 2, 0);
INSERT INTO `db`.`layout` (`idlayout`, `description`, `quantity`, `orientation`) VALUES (4, 'h1:2', 2, 0);
INSERT INTO `db`.`layout` (`idlayout`, `description`, `quantity`, `orientation`) VALUES (5, 'h1:1:1', 3, 0);
INSERT INTO `db`.`layout` (`idlayout`, `description`, `quantity`, `orientation`) VALUES (6, 'v1', 1, 1);
INSERT INTO `db`.`layout` (`idlayout`, `description`, `quantity`, `orientation`) VALUES (1, 'h1', 1, 0);
INSERT INTO `db`.`layout` (`idlayout`, `description`, `quantity`, `orientation`) VALUES (7, 'v1:1', 2, 1);
INSERT INTO `db`.`layout` (`idlayout`, `description`, `quantity`, `orientation`) VALUES (8, 'v2:1:1', 3, 1);
