...
START TRANSACTION;
USE `db`;
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (3, 'hjl2a', DEFAULT, 2, 1, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (4, 'hjl3a', DEFAULT, 3, 1, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (6, 'hjp1a', DEFAULT, 1, 2, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (7, 'hjp2a', DEFAULT, 2, 2, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (8, 'hjp3a', DEFAULT, 3, 2, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (2, 'hjl1a', DEFAULT, 1, 1, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (9, 'hpl1a', DEFAULT, 1, 1, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (10, 'hpl2a', DEFAULT, 2, 1, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (11, 'hpl2b', DEFAULT, 2, 1, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (12, 'hpl2c', DEFAULT, 2, 1, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (13, 'hpl3a', DEFAULT, 3, 1, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (14, 'hpl3b', DEFAULT, 3, 1, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (15, 'hpl3c', DEFAULT, 3, 1, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (16, 'hpp1a', DEFAULT, 1, 2, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (17, 'hpp2a', DEFAULT, 2, 2, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (18, 'hpp2b', DEFAULT, 2, 2, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (19, 'hpp3a', DEFAULT, 3, 2, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (20, 'hpp3b', DEFAULT, 3, 2, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (21, 'hpp3c', DEFAULT, 3, 2, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (22, 'hpp3d', DEFAULT, 3, 2, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (1, 'hjl0a', DEFAULT, 0, 1, 0);
INSERT INTO `db`.`layout` (`idlayout`, `identifier`, `description`, `quantity`, `orientation`, `full_page`) VALUES (5, 'hjp0a', DEFAULT, 0, 2, 0);
